...
const { signMetadata, signPackageMetadata } = require('./update-signature');
...
if (metadata.asarSha512) metadata.packageSignature = signPackageMetadata(metadata, privateKey);
